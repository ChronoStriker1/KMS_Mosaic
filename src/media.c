...
static void media_apply_option_list(media_ctx *m, const char *const *opts, int count,
    ...
    for (int i = 0; i < count; i++) {
        ...
        else if (media_key_matches(kv, "keep-open")) *user_set_keep_open = true;
